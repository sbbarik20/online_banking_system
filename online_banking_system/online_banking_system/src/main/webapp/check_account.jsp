    ...
    <body>
        ...
        <section class="home-section">
            ...
            <div class="home-content">
                <h2 style="text-align: center;"><u>CHECK YOUR ACCOUNT BALANCE</u></h2>
                <form action="chk_balance" method="post">
                    <c:forEach var="user" items="${blnc}">
                        <h3>Please Check your account number:</h3>
                        <input type="number" name="accountno" id="accountno" value="${user.accountno}" readonly>
                        <input type="submit" value="Check">
                        <h2>Your Account Balance is: </h2>${user.balance}
                    </c:forEach>
                </form>
            </div>
